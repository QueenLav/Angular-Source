...
@Component({
  selector: 'app-send-email-list',
  templateUrl: './send-email-list.component.html',
  styleUrls: ['./send-email-list.component.scss']
})

export class SendEmailListComponent implements OnInit {
