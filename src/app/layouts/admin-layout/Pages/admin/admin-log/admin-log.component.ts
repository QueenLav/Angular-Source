...
export class AdminLogComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private httpClient : HttpClient, private route: ActivatedRoute,  private notifyService : NotificationService) {
    ...
    this.adminLogForm = this.fb.group({
  ...
  public getAdminlog(){
    ...
    this.httpClient.post('admin-auth/admin-log-history/' + this.admin_id, jsonInput).subscribe((data:any= {}) => {
      if(data.response == 'success'){
        ...
        this.adminLogData =  data.data[0].admin_log;
  ...
  pageCallback(evnt) {
    ...
    let jsonInput :any = { 
      "start_date" :  this.adminLogForm.controls['start_date'].value,
      "end_date" :  this.adminLogForm.controls['end_date'].value,
      "offset":offset,
      "limit":evnt.limit,
